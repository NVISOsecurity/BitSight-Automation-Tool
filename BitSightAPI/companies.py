...
class Companies(Session):
    """
    Companies class
    # For assets: https://service.bitsighttech.com/customer-api/v1/companies/{guid}/assets?limit=4112&offset=0&q=&sort=-combined_overrides.importance
    """
